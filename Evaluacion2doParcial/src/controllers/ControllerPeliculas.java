...
public class ControllerPeliculas {
    ...
    public ControllerPeliculas(ModelPeliculas model_peliculas, ViewPeliculas view_peliculas){
        ...
        view_peliculas.jbtn_modificar.addActionListener(e-> jbtn_anterior_click());
        ...
        view_peliculas.jbtn_modificar.addActionListener(e-> jbtn_editar_click());
    ...
    public void initView(){
        ...
        view_peliculas.jtf_idpelicula.setEditable(false);
    ...
    public void setValores(){
        ...
        agregar_true();
        view_peliculas.jtf_idpelicula.setText("0");
    ...
    public void agregar_falso(){
        view_peliculas.jbtn_agregar.setEnabled(false);
        view_peliculas.jbtn_modificar.setEnabled(true);
    ...
    public void agregar_true(){
        ...
        view_peliculas.jbtn_modificar.setEnabled(false);        
    }
}
