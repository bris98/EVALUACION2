...
public class ControllerClientes {
    ...
    public ControllerClientes(ModelClientes model_clientes, ViewClientes view_clientes){
        ...
        view_clientes.jbtn_anterior.addActionListener(e-> jbtn_primero_click());
        ...
        view_clientes.jbtn_modificar.addActionListener(e-> jbtn_editar_click());
    ...
    public void initView(){
        ...
        view_clientes.jtf_idcliente.setEditable(false);
    ...
    public void jbtn_nuevo_click(){
        agregar_true();
        view_clientes.jtf_idcliente.setText("0");
