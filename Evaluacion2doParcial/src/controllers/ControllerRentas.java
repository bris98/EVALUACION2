...
public class ControllerRentas {
    ...
    public void getValores(){
        ...
        view_rentas.jtf_costo.setText("" + model_rentas.getCosto_dia());
        view_rentas.jtf_dias.setText("" + model_rentas.getDias());
        view_rentas.jtf_total.setText("" + model_rentas.getTotal_renta());
    ...
    public void setValores(){
        ...
        model_rentas.setCosto_dia(Integer.parseInt(view_rentas.jtf_costo.getText()));
        model_rentas.setDias(Integer.parseInt(view_rentas.jtf_dias.getText()));
        model_rentas.setTotal_renta(Integer.parseInt(view_rentas.jtf_total.getText()));
    }    
